...
t2g = Text2GraphTransformer(n_jobs=8, min_df=10, save_path=None, verbose=1, max_df=0.5)
...
# scheduler = th.optim.lr_scheduler.ReduceLROnPlateau(optimizer, verbose=True, factor=0.5, patience=15, cooldown=15)
scheduler = th.optim.lr_scheduler.OneCycleLR(optimizer, max_lr=0.5, steps_per_epoch=1, epochs=500, final_div_factor=1e3)
history = []
